...
#ifdef QT_MOC_HAS_STRINGDATA
struct qt_meta_stringdata_CLASSDBServerENDCLASS_t {};
static constexpr auto qt_meta_stringdata_CLASSDBServerENDCLASS = QtMocHelpers::stringData(
    "DBServer",
    "incomingConnection",
    "",
    "qintptr",
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASSDBServerENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASSDBServerENDCLASS_t qt_meta_stringdata_CLASSDBServerENDCLASS = {
    {
        QT_MOC_LITERAL(0, 8),  // "DBServer"
        QT_MOC_LITERAL(9, 18),  // "incomingConnection"
        QT_MOC_LITERAL(28, 0),  // ""
        QT_MOC_LITERAL(29, 7),  // "qintptr"
        QT_MOC_LITERAL(37, 16),  // "socketDescriptor"
        QT_MOC_LITERAL(54, 9),  // "sockReady"
        QT_MOC_LITERAL(64, 8)   // "sockDisc"
    },
    "DBServer",
    "incomingConnection",
    "",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSDBServerENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject DBServer::staticMetaObject = { {
    QMetaObject::SuperData::link<Server::staticMetaObject>(),
    qt_meta_stringdata_CLASSDBServerENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSDBServerENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSDBServerENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<DBServer, std::true_type>,
        // method 'incomingConnection'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        QtPrivate::TypeAndForceComplete<qintptr, std::false_type>,
        // method 'sockReady'
...
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<DBServer *>(_o);
        (void)_t;
        switch (_id) {
        case 0: _t->incomingConnection((*reinterpret_cast< std::add_pointer_t<qintptr>>(_a[1]))); break;
        case 1: _t->sockReady(); break;
...
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_CLASSDBServerENDCLASS.stringdata0))
        return static_cast<void*>(this);
